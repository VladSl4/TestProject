...
from gateway.models.analysis_dtos import LogCategoryDto
...
def test_empty_logs_returns_info_category():
    ...
    assert insight.category == LogCategoryDto.INFO
...
def test_warning_logs_are_detected():
    ...
    assert insight.category == LogCategoryDto.WARNING
...
def test_error_outranks_warning():
    ...
    assert insight.category == LogCategoryDto.ERROR
